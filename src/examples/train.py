...
sim = Simulation("step load", t_end=sim_len, dt=1.0, vary_loads=True, vary_loads_every=180, vary_loads_min_gap=90, seed=11) # "test"=seed 12 |"train"= seed 11 |"val"= seed 10

t_switching = benign_switching(sim, s, "train", sim_len)

schedule_attacks(s, attacker=None, t_end = sim_len, switching_times=t_switching)
